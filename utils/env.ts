...
export const GOERLI_TOKEN_1 = process.env.GOERLI_TOKEN_1 || "0x1d9EddB94868148ef955A7234c527b3bb1483462";
export const GOERLI_TOKEN_2 = process.env.GOERLI_TOKEN_2 || "0xd40CbdeFa404A6092AFa265BdD69bA531c73458D";
export const GOERLI_TOKEN_3 = process.env.GOERLI_TOKEN_3 || "0x0b0DDE4d7eD00D3bB472a009ecEeFFdD894323b3";
export const GOERLI_TOKEN_4 = process.env.GOERLI_TOKEN_4 || "0x9e6795350AD0B0Bf55Cf29F78100CAf6acc6F84B";
export const GOERLI_UTILITY = process.env.GOERLI_UTILITY || "0x4d391169EcF040072d8Da35d70166f70254B32C7";

export const CHAINS = ["localhost", "hardhat", "goerli"];
export const JSON_LOCATION = process.env.JSON_LOCATION || "utils/json/constants.json";
